...
?>
    ...
    <head>
        ...
        <link href="<?= STATIC_SERVER ?>styles/public/style.css?v=<?= filemtime(SERVER_ROOT . '/static/styles/public/style.css') ?>"
              rel="stylesheet"
              type="text/css">
        <?php
        ...
        $img = array_diff((array) scandir(SERVER_ROOT . '/misc/bg', 1), ['.', '..']); ?>
