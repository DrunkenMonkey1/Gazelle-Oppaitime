(function (d, f, g, b) {
    ...
    function a () {
        ...
        for (var n = 0; n < v.length; n++) {if (typeof o[v[n] + q] == 'string') {return true;}}
        return false;
    }
    ...
    j.prototype = {
        init: function () {
            ...
            var o = this;
            var r = true;
            if ((o.options.touchDevices == false) && (h)) {r = false;}
            if (g.all && !g.querySelector) {r = false;}
            if (r == true) {
                ...
                if ((this.options.touchDevices == true) && (h) && ((this.options.trigger == 'click') || (this.options.trigger == 'hover'))) {
                    ...
                    if (this.options.trigger == 'click') {
                        s.on('click.tooltipster', function () {
                            if ((s.data('tooltipster') == '') || (s.data('tooltipster') == b)) {o.showTooltip();} else {o.hideTooltip();}
                        });
                    }
                }
            }
            ...
            var m = this;
            if (o.data('tooltipsterIcon') !== b) {o = o.data('tooltipsterIcon');}
                    ...
                    m.options.functionBefore(o, function () {
                        if ((o.data('tooltipster') !== b) && (o.data('tooltipster') !== '')) {
                            ...
                            if (!y.hasClass('tooltipster-kill')) {
                                ...
                                if (l == true) {y.clearQueue().addClass(u + '-show');}
                                    ...
                                    d('body').bind('touchstart', function (D) {
                                        if (m.options.interactive == true) {
                                            ...
                                            F.parents().each(function () {
                                                if (d(this).hasClass('tooltipster-base')) {E = false;}
                                            });
                                            if (E == true) {
                                                m.hideTooltip();
                            ...
                            if (l == true) {y.addClass(u + '-show');} else {y.css('display', 'none').removeClass(u).fadeIn(m.options.speed);}
                            var C = z;
                            var q = setInterval(function () {
                                ...
                                if ((d('body').find(y).length == 0) || (d('body').find(o).length == 0)) {clearInterval(q);}
                            }, 200);
                            if (m.options.timer > 0) {
            ...
            var m = this;
            if (q.data('tooltipsterIcon') !== b) {q = q.data('tooltipsterIcon');}
            var p = q.data('tooltipster');
            if (p == b) {p = d('.tooltipster-dying');}
            q.clearQueue();
            if ((p !== b) && (p !== '')) {
                var r = p.data('tooltipsterTimer');
                if (r !== b) {clearTimeout(r);}
            ...
            var ac = this;
            if (B.data('tooltipsterIcon') !== b) {B = B.data('tooltipsterIcon');}
            if ((B.data('tooltipster') !== b) && (B.data('tooltipster') !== '')) {
                ...
                if (ac.options.arrow == true) {
                    ...
                    if (ac.options.arrowColor.length < 1) {var S = ai.css('background-color');} else {var S = ac.options.arrowColor;}
                    ...
                    if (V !== 0) {
                        ...
                        if (J.indexOf('bottom') !== -1) {D = 'margin-top: -' + V + 'px;';} else {if (J.indexOf('top') !== -1) {D = 'margin-bottom: -' + V + 'px;';} else {if (J.indexOf('left') !== -1) {D = 'margin-right: -' + V + 'px;';} else {if (J.indexOf('right') !== -1) {D = 'margin-left: -' + V + 'px;';}}}}
    ...
    d.fn[e] = function (n) {
        if (typeof n === 'string') {
            ...
            if (p.data('plugin_tooltipster') == b) {
                ...
                p = d();
                o.each(function () {
                    if (d(this).data('plugin_tooltipster') !== b) {p.push(d(this));}
                });
            }
            p.each(function () {
                switch (n.toLowerCase()) {
                    ...
                    case'destroy':
                        ...
                        break;
                    case'update':
                        if (d(this).data('tooltipsterIcon') == b) {d(this).data('tooltipsterContent', m);} else {
        ...
        return this.each(function () {
            if (!d.data(this, 'plugin_' + e)) {d.data(this, 'plugin_' + e, new j(this, n));}
    ...
    d(f).on('resize.tooltipster', function () {
        ...
        if ((m !== null) && (m !== b)) {m.tooltipster('reposition');}
    });
...
$(function () {
    if (!$.fn.tooltipster) {
        window.setTimeout(tooltipster_init, 500);
        return;
    }
