...
$(document).ready(function () {
    $('#random_password').click(function () {
        $('#change_password').val(randPassword(6, 6, 6, 6));
    });
});

function randPassword (letters, numbers, either, characters) {
    const chars = [
    ...
    return [letters, numbers, either, characters].map(function (len, i) {
