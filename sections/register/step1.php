                ...
                <table class="layout" cellpadding="2" cellspacing="1" border="0" align="center">
                    <tr valign="top">
                        ...
                        <td align="left">
                            ...
                            <p>Use common sense when choosing your username. <strong>Do not choose a username that can
                                    be associated with your real name.</strong> If you do so, we will not be changing it
                                for you.</p>
                        </td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td align="left">
                            <input type="email"
                                   ...
                                   class="inputtext"
                                   placeholder="Email"
                                   value="<?= (empty($_REQUEST['email']) ? empty($InviteEmail) ? '' : display_str($InviteEmail) : (display_str($_REQUEST['email']))) ?>"/>
                        </td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td align="left">
                            <input type="password"
                                   ...
                                   id="new_pass_1"
                                   class="inputtext"
                                   placeholder="Password"/> <strong id="pass_strength"></strong>
                        </td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td align="left">
                            <input type="password"
                                   ...
                                   id="new_pass_2"
                                   class="inputtext"
                                   placeholder="Verify password"/> <strong id="pass_match"></strong>
                    ...
                    <tr valign="top">
                        ...
                        <td align="left">
                            <input type="checkbox"
                                   name="readrules"
                                   id="readrules"
                                   value="1"<?php if (!empty($_REQUEST['readrules'])) { ?> checked="checked"<?php } ?> />
                    ...
                    <tr valign="top">
                        ...
                        <td align="left">
                            <input type="checkbox"
                                   name="readwiki"
                                   id="readwiki"
                                   value="1"<?php if (!empty($_REQUEST['readwiki'])) { ?> checked="checked"<?php } ?> />
                    ...
                    <tr valign="top">
                        ...
                        <td align="left">
                            <input type="checkbox"
                                   name="agereq"
                                   id="agereq"
                                   value="1"<?php if (!empty($_REQUEST['agereq'])) { ?> checked="checked"<?php } ?> />
                    ...
                    <tr>
                        <td colspan="2" align="right"><input type="submit" name="submit" value="Submit" class="submit"/>
                        </td>
                    </tr>
                </table>
                <?php
            } else {
                if (false !== FEATURE_SEND_EMAIL) { ?>
                    You can login
                <?php } else { ?>
