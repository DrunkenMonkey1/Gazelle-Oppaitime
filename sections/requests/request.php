...
<?php  } ?>
      <a href="#" id="subscribelink_requests<?=$RequestID?>" class="brackets" onclick="SubscribeComments('requests',<?=$RequestID?>);return false;"><?=false !== Subscriptions::has_subscribed_comments('requests', $RequestID) ? 'Unsubscribe' : 'Subscribe'?></a>
