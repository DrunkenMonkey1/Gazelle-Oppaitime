    ...
    <form class="search_form" name="torrents" method="get" onsubmit="$(this).disableUnset();">
                    ...
                    <tr id="tagfilter">
                        ...
                        <td class="ft_taglist">
                            <input type="search"
                                   ...
                                   value="<?= display_str($Search->get_terms('taglist')) ?>"<? Users::has_autocomplete_enabled('other'); ?>
                                   aria-label="Tags to search">&nbsp;
                            <input type="radio"
                                   name="tags_type"
                                   id="tags_type0"
                                   value="0"<? Format::selected('tags_type', 0, 'checked') ?> /><label for="tags_type0">
                                Any</label>&nbsp;&nbsp;
                            <input type="radio"
                                   name="tags_type"
                                   id="tags_type1"
                                   value="1"<? Format::selected('tags_type', 1, 'checked') ?> /><label for="tags_type1">
                                All</label>
                        </td>
                    </tr>
                    <tr id="order">
                        ...
                        <td class="ft_order">
                            <select name="order_by"
                                ...
                                <option value="cataloguenumber"<? Format::selected('order_by', 'cataloguenumber') ?>>
                                    Catalogue Number
                                </option>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox"
                                   ...
                                   id="cat_<?= ($CatKey + 1) ?>"
                                   value="1"<? if (isset($_GET['filter_cat'][$CatKey + 1])) { ?> checked="checked"<? } ?> />
      ...
      ORDER BY Name');
                ...
                <div class="submit ft_submit">
                    ...
                    <input type="button"
                           value="Reset"
                           onclick="location.href = 'torrents.php<? if (isset($_GET['action']) && $_GET['action'] === 'advanced') { ?>?action=advanced<? } ?>'"/>
                    &nbsp;&nbsp;
...
<? } ?>
        | <a href="reportsv2.php?action=report&amp;id=<?= $TorrentID ?>" class="tooltip" title="Report">RP</a> ]
                        ...
                        &raquo;
                        <a href="torrents.php?id=<?= $GroupID ?>&amp;torrentid=<?= $TorrentID ?>"><?= Torrents::torrent_info($Data) ?><? if ($Reported) { ?> /
          ...
          | <a href="reportsv2.php?action=report&amp;id=<?= $TorrentID ?>" class="tooltip" title="Report">RP</a> ]
            ...
            <a href="#"
               ...
               onclick="Bookmark('torrent', <?= $GroupID ?>, 'Remove bookmark'); return false;">Bookmark</a>
                        ...
                        <?= $DisplayName ?>
                        <br/>
                        <div style="display: inline;" class="torrent_info"><?= $ExtraInfo ?><? if ($Reported) { ?> /
                            <strong class="torrent_label tl_reported tooltip"
                                    title="Type: <?= ucfirst($Reports[0]['Type']) ?><br>Comment: <?= htmlentities(htmlentities($Reports[0]['UserComment'])) ?>">
                                    Reported</strong><? } ?></div>
                        <div class="tags"><?= $TorrentTags->format("torrents.php?$Action&amp;taglist=") ?></div>
