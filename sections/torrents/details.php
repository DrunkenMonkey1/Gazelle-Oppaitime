...
// Group details
[$WikiBody, $WikiImage, $GroupID, $GroupName, $GroupNameRJ, $GroupNameJP, $GroupYear,
...
<?php  } ?>
      <a href="#" id="subscribelink_torrents<?=$GroupID?>" class="brackets" onclick="SubscribeComments('torrents', <?=$GroupID?>); return false;"><?=false !== Subscriptions::has_subscribed_comments('torrents', $GroupID) ? 'Unsubscribe' : 'Subscribe'?></a>
<?php
...
foreach ($TorrentList as $Torrent) {
    [$TorrentID, $Media, $Container, $Codec, $Resolution, $AudioFormat, $Subbing,
...
<?php
    ...
    if (in_array($LoggedUser['ID'], $DB->collect('UserID'), true) || check_perms('torrents_edit') || check_perms('screenshots_add') || check_perms('screenshots_delete')) {
        ?>
