...
<?php  if (check_perms('site_collages_delete') || (0 == $CategoryID && $UserID == $LoggedUser['ID'] && check_perms('site_collages_renamepersonal'))) { ?>
      <tr>
...
<?php
  foreach ($CollageCats as $CatID => $CatName) {
      if (!check_perms('site_collages_delete') && 0 == $CatID) {
...
<?php  if (0 == $CategoryID) { // CategoryID == 0 is for "personal" collages?>
      <tr>
