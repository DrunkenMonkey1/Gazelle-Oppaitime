...
View::show_header(sprintf('Manage collection: %s', $Name), 'jquery-ui,jquery.tablesorter,sort');
...
<div class="thin">
        ...
        <tr>
            <td id="drag_drop_textnote">
                <ul>
                    ...
                    <li>Sort multiple columns simultaneously by holding down the shift key and clicking other column
                        headers.
                    </li>
    ...
    <table id="manage_collage_table">
        ...
        <tr class="colhead">
            ...
            <th style="width: 1%; text-align: right;" class="nobr" data-sorter="false"><span><abbr class="tooltip"
                                                                                                   title="Modify an individual row">Tweak</abbr></span>
            </th>
        </tr>
        </thead>
        <tbody>
        ...
        foreach ($GroupIDs as $GroupID) {
            ...
            $GroupNameLang = $GroupName;
            $TorrentLink = sprintf('<a href="torrents.php?id=%s" class="tooltip" title="View torrent group">%s</a>',
                $GroupID, $GroupNameLang);
    ...
    <form class="dragdrop_form hidden" name="collage" action="collages.php" method="post" id="drag_drop_collage_form">
        <div>
            ...
            <input type="hidden"
                   name="drag_drop_collage_sort_order"
                   id="drag_drop_collage_sort_order"
                   readonly="readonly"
                   value=""/>
        </div>
    </form>
