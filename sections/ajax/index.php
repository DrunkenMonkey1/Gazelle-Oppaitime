...
if (!in_array($UserID, $UserExceptions, true) && isset($_GET['action']) && in_array($_GET['action'], $LimitedPages,
        true)) {
...
switch ($_GET['action']) {
    ...
    case 'preview':
        ...
        break;
    case 'torrent_info':
        require __DIR__ . '/torrent_info.php';
        break;
    case 'stats':
    ...
    case 'checkprivate':
        include __DIR__ . '/checkprivate.php';
        break;
    // things not yet used on the site
    case 'torrent':
        require __DIR__ . '/torrent.php';
        break;
    case 'torrentgroup':
        require __DIR__ . '/torrentgroup.php';
        break;
