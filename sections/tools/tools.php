 ...
 * @param string|bool $Tooltip       - optional tooltip
 */
function create_row(string $Title, string $URL, bool $HasPermission = false, string|bool $Tooltip = false): void
{
    if ($HasPermission) {
        global $ToolsHTML;
        $TooltipHTML = false !== $Tooltip ? sprintf(' class="tooltip" title="%s"', $Tooltip) : "";
...
<div class="permissions">
    <div class="permission_container">
        ...
        create_row("Bitcoin donations (unprocessed)", "tools.php?action=bitcoin_unproc",
            check_perms("admin_donor_log"));
...
//        create_row("Mod-level sandbox", "tools.php?action=mod_sandbox", check_perms("users_mod"), "Do not click this!");
    ...
    <div class="permission_container">
        ...
        create_row("Registration log", "tools.php?action=registration_log",
            check_perms("users_view_ips") && check_perms("users_view_email"));
        ...
        create_row("Rerender stylesheet gallery images", "tools.php?action=rerender_gallery",
            check_perms("site_debug") || check_perms("users_mod"));
        create_row("Schedule", sprintf('schedule.php?auth=%s', $LoggedUser['AuthKey']), check_perms("site_debug"));
