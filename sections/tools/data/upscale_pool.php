...
<?php
  while ([$UserID, $Username, $Uploaded, $Downloaded, $PermissionID, $Enabled, $Donor, $Warned, $Joined, $RatioWatchEnds, $RatioWatchDownload, $RequiredRatio] = $DB->next_record()) {
      ?>
    <tr class="row">
      ...
      <td class="number_column"><?php if (($Downloaded * $RequiredRatio) > $Uploaded) {
