...
if ([] !== $_GET) {
    ...
    if (isset($_GET['matchtype']) && 'strict' == $_GET['matchtype']) {
        $Match = ' = ';
    } elseif (isset($_GET['matchtype']) && 'regex' == $_GET['matchtype']) {
        $Match = ' REGEXP ';
    } else {
        $Match = ' LIKE ';
    }
      ...
      FROM users_main AS um1
        ...
        HAVING COUNT(DISTINCT Email) ";
            if ('equal' === $_GET['emails_opt']) {
                $operator = '=';
            }
            if ('above' === $_GET['emails_opt']) {
                $operator = '>';
            }
            if ('below' === $_GET['emails_opt']) {
                $operator = '<';
            }
        ...
        if ('' != $_GET['lockedaccount'] && 'any' != $_GET['lockedaccount']) {
            $Join['la'] = '';

            if ('unlocked' == $_GET['lockedaccount']) {
                $Join['la'] .= ' LEFT';
...
//    }
        ...
        if (strlen($_GET['invitees1']) && 'off' != $_GET['invitees']) {
  ...
  <form class="search_form" name="users" action="user.php" method="get">
    ...
    <table class="layout">
      <tr>
        ...
        <td width="24%">
          <select name="joined">
            <option value="on"<?php      if ('on' === $_GET['joined']) {
    echo ' selected="selected"';
} ?>>On</option>
            <option value="before"<?php  if ('before' === $_GET['joined']) {
    echo ' selected="selected"';
} ?>>Before</option>
            <option value="after"<?php   if ('after' === $_GET['joined']) {
    echo ' selected="selected"';
} ?>>After</option>
            <option value="between"<?php if ('between' === $_GET['joined']) {
    echo ' selected="selected"';
} ?>>Between</option>
          </select>
    ...
    echo ' selected="selected"';
            ...
            <option value="0"<?php if ('0' === $_GET['enabled']) {
    echo ' selected="selected"';
} ?>>Unconfirmed</option>
            <option value="1"<?php if ('1' === $_GET['enabled']) {
    echo ' selected="selected"';
} ?>>Enabled</option>
            <option value="2"<?php if ('2' === $_GET['enabled']) {
    echo ' selected="selected"';
} ?>>Disabled</option>
          </select>
        </td>
      ...
      <tr>
        ...
        <td width="30%">
          <select name="lastactive">
            <option value="on"<?php      if ('on' === $_GET['lastactive']) {
    echo ' selected="selected"';
} ?>>On</option>
            <option value="before"<?php  if ('before' === $_GET['lastactive']) {
    echo ' selected="selected"';
} ?>>Before</option>
            <option value="after"<?php   if ('after' === $_GET['lastactive']) {
    echo ' selected="selected"';
} ?>>After</option>
            <option value="between"<?php if ('between' === $_GET['lastactive']) {
    echo ' selected="selected"';
} ?>>Between</option>
          </select>
...
<?php  foreach ($ClassLevels as $Class) {
    if ($Class['Secondary']) {
        continue;
            ...
            <option value="<?=$Class['ID'] ?>"<?php if ($_GET['class'] === $Class['ID']) {
        echo ' selected="selected"';
      ...
      <tr>
        ...
        <td>
          <select name="lockedaccount">
            <option value="any"<?php if ('any' == $_GET['lockedaccount']) {
        echo ' selected="selected"';
    } ?>>Any</option>
            <option value="locked"<?php if ('locked' == $_GET['lockedaccount']) {
        echo ' selected="selected"';
    } ?>>Locked</option>
            <option value="unlocked"<?php if ('unlocked' == $_GET['lockedaccount']) {
        echo ' selected="selected"';
    } ?>>Unlocked</option>
          </select>
        </td>
...
<?php  $Secondaries = [];
  ...
  foreach ($Secondaries as $Class) {
      ?>
            <option value="<?=$Class['ID'] ?>"<?php if ($_GET['secclass'] === $Class['ID']) {
          echo ' selected="selected"';
...
<?php
      ...
      echo ' checked="checked"';
        ...
        <td width="30%">
          <select name="ratio">
            <option value="equal"<?php   if ('equal' === $_GET['ratio']) {
      echo ' selected="selected"';
  } ?>>Equal</option>
            <option value="above"<?php   if ('above' === $_GET['ratio']) {
      echo ' selected="selected"';
  } ?>>Above</option>
            <option value="below"<?php   if ('below' === $_GET['ratio']) {
      echo ' selected="selected"';
  } ?>>Below</option>
            <option value="between"<?php if ('between' === $_GET['ratio']) {
      echo ' selected="selected"';
  } ?>>Between</option>
          </select>
      ...
      echo ' selected="selected"';
            ...
            <option value="yes"<?php if ('yes' === $_GET['donor']) {
      echo ' selected="selected"';
  } ?>>Yes</option>
            <option value="no"<?php  if ('no' === $_GET['donor']) {
      echo ' selected="selected"';
  } ?>>No</option>
          </select>
        </td>
...
<?php  } ?>
        ...
        <td width="30%">
          <select name="uploaded">
            <option value="equal"<?php   if ('equal' === $_GET['uploaded']) {
      echo ' selected="selected"';
  } ?>>Equal</option>
            <option value="above"<?php   if ('above' === $_GET['uploaded']) {
      echo ' selected="selected"';
  } ?>>Above</option>
            <option value="below"<?php   if ('below' === $_GET['uploaded']) {
      echo ' selected="selected"';
  } ?>>Below</option>
            <option value="between"<?php if ('between' === $_GET['uploaded']) {
      echo ' selected="selected"';
  } ?>>Between</option>
            <option value="buffer"<?php  if ('buffer' === $_GET['uploaded']) {
      echo ' selected="selected"';
  } ?>>Buffer</option>
          </select>
      ...
      echo ' selected="selected"';
            ...
            <option value="yes"<?php if ('yes' === $_GET['warned']) {
      echo ' selected="selected"';
  } ?>>Yes</option>
            <option value="no"<?php  if ('no' === $_GET['warned']) {
      echo ' selected="selected"';
  } ?>>No</option>
          </select>
        </td>
      ...
      <tr>
        ...
        <td>
          <select name="invites">
            <option value="equal"<?php   if ('equal' === $_GET['invites']) {
      echo ' selected="selected"';
  } ?>>Equal</option>
            <option value="above"<?php   if ('above' === $_GET['invites']) {
      echo ' selected="selected"';
  } ?>>Above</option>
            <option value="below"<?php   if ('below' === $_GET['invites']) {
      echo ' selected="selected"';
  } ?>>Below</option>
            <option value="between"<?php if ('between' === $_GET['invites']) {
      echo ' selected="selected"';
  } ?>>Between</option>
          </select>
        ...
        <td width="30%">
          <select name="downloaded">
            <option value="equal"<?php   if ('equal' === $_GET['downloaded']) {
      echo ' selected="selected"';
  } ?>>Equal</option>
            <option value="above"<?php   if ('above' === $_GET['downloaded']) {
      echo ' selected="selected"';
  } ?>>Above</option>
            <option value="below"<?php   if ('below' === $_GET['downloaded']) {
      echo ' selected="selected"';
  } ?>>Below</option>
            <option value="between"<?php if ('between' === $_GET['downloaded']) {
      echo ' selected="selected"';
  } ?>>Between</option>
          </select>
      ...
      echo ' selected="selected"';
            ...
            <option value="yes"<?php if ('yes' === $_GET['disabled_invites']) {
      echo ' selected="selected"';
  } ?>>Yes</option>
            <option value="no"<?php  if ('no' === $_GET['disabled_invites']) {
      echo ' selected="selected"';
  } ?>>No</option>
          </select>
        </td>
        ...
        <td width="30%">
          <select name="snatched">
            <option value="equal"<?php   if (isset($_GET['snatched']) && 'equal' === $_GET['snatched']) {
      echo ' selected="selected"';
  } ?>>Equal</option>
            <option value="above"<?php   if (isset($_GET['snatched']) && 'above' === $_GET['snatched']) {
      echo ' selected="selected"';
  } ?>>Above</option>
            <option value="below"<?php   if (isset($_GET['snatched']) && 'below' === $_GET['snatched']) {
      echo ' selected="selected"';
  } ?>>Below</option>
            <option value="between"<?php if (isset($_GET['snatched']) && 'between' === $_GET['snatched']) {
      echo ' selected="selected"';
  } ?>>Between</option>
            <option value="off"<?php     if (!isset($_GET['snatched']) || 'off' === $_GET['snatched']) {
      echo ' selected="selected"';
  } ?>>Off</option>
          </select>
      ...
      echo ' selected="selected"';
            ...
            <option value="yes"<?php if (isset($_GET['disabled_uploads']) && 'yes' === $_GET['disabled_uploads']) {
      echo ' selected="selected"';
  } ?>>Yes</option>
            <option value="no"<?php  if (isset($_GET['disabled_uploads']) && 'no' === $_GET['disabled_uploads']) {
      echo ' selected="selected"';
  } ?>>No</option>
          </select>
        </td>
      ...
      <tr>
        ...
        <td>
          <select name="invitees">
            <option value="equal" <?=isset($_GET['invitees']) && 'equal' == $_GET['invitees'] ? 'selected' : ''?>>Equal</option>
            <option value="above" <?=isset($_GET['invitees']) && 'above' == $_GET['invitees'] ? 'selected' : ''?>>Above</option>
            <option value="below" <?=isset($_GET['invitees']) && 'below' == $_GET['invitees'] ? 'selected' : ''?>>Below</option>
            <option value="between" <?=isset($_GET['invitees']) && 'between' == $_GET['invitees'] ? 'selected' : ''?>>Between</option>
            <option value="off" <?=!isset($_GET['invitees']) || 'off' == $_GET['invitees'] ? 'selected' : ''?>>Off</option>
          </select>
...
<?php          } ?>
        ...
        <td width="30%">
          <select name="cc_op">
            <option value="equal"<?php     if ('equal' === $_GET['cc_op']) {
      echo ' selected="selected"';
  } ?>>Equals</option>
            <option value="not_equal"<?php if ('not_equal' === $_GET['cc_op']) {
      echo ' selected="selected"';
  } ?>>Not equal</option>
          </select>
      ...
      <tr>
        ...
        <td>
          <ul class="options_list nobullet">
            <li>
              <input type="radio" name="matchtype" id="strict_match_type" value="strict"<?php if ('strict' == $_GET['matchtype'] || !$_GET['matchtype']) {
      echo ' checked="checked"';
  } ?> />
            ...
            <li>
              <input type="radio" name="matchtype" id="fuzzy_match_type" value="fuzzy"<?php if ('fuzzy' == $_GET['matchtype'] || !$_GET['matchtype']) {
      echo ' checked="checked"';
  } ?> />
            ...
            <li>
              <input type="radio" name="matchtype" id="regex_match_type" value="regex"<?php if ('regex' == $_GET['matchtype']) {
      echo ' checked="checked"';
  } ?> />
...
<?php
            ...
            <option value="<?=$Cur?>"<?php if (isset($_GET['order']) && $_GET['order'] == $Cur || (!isset($_GET['order']) && 'Joined' == $Cur)) {
                echo ' selected="selected"';
            } ?>><?=$Cur?></option>
<?php            } ?>
          </select>
...
<?php            foreach (array_shift($WayVals) as $Cur) { ?>
            <option value="<?=$Cur?>"<?php if (isset($_GET['way']) && $_GET['way'] == $Cur || (!isset($_GET['way']) && 'Descending' == $Cur)) {
                echo ' selected="selected"';
            } ?>><?=$Cur?></option>
<?php            } ?>
          </select>
        ...
        <td>
          <select name="emails_opt">
            <option value="equal"<?php if ('equal' === $_GET['emails_opt']) {
                echo ' selected="selected"';
            } ?>>Equal</option>
            <option value="above"<?php if ('above' === $_GET['emails_opt']) {
                echo ' selected="selected"';
            } ?>>Above</option>
            <option value="below"<?php if ('below' === $_GET['emails_opt']) {
                echo ' selected="selected"';
            } ?>>Below</option>
          </select>
...
if ($RunQuery) {
                ...
                if (!empty($_GET['email'])) {
                    ...
                    while ([$ID, $EncEmail] = $DB->next_record()) {
...
<div class="box pad center">
  ...
  <table width="100%">
    <tr class="colhead">
      ...
      <td>Snatched</td>
      <td>Invites</td>
<?php  if (isset($_GET['invitees']) && 'off' != $_GET['invitees']) { ?>
      <td>Invitees</td>
<?php  } ?>
    </tr>
<?php
while ([$UserID, $Username, $Uploaded, $Downloaded, $Snatched, $Invitees, $Class, $Email, $Enabled, $IP, $Invites, $DisableInvites, $Warned, $Donor, $JoinDate, $LastAccess] = $DB->next_record()) {
