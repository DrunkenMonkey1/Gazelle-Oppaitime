...
if ($Type = $_POST['type'] ?? false) {
    if ('PGP' == $Type) {
        if (!empty($_POST['publickey']) && (false === strpos($_POST['publickey'], 'BEGIN PGP PUBLIC KEY BLOCK') || false === strpos($_POST['publickey'], 'END PGP PUBLIC KEY BLOCK'))) {
