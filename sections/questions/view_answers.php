...
<?php    if ($Question['Responses'] > 0) { ?>
        <a href="#" data-gazelle-userid="<?=$UserID?>" id="<?=$Question['ID']?>" class="view_responses brackets"><?=1 == $Question['Responses'] ? ("View " . $Question['Responses'] . " other response") : ("View " . $Question['Responses'] . " other responses")?></a>
        -
<?php
    }
