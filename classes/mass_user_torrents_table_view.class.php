...
class MASS_USER_TORRENTS_TABLE_VIEW
{
     ...
     * @var string $Heading
     */
    private string $Heading = 'Manage Torrents';
     ...
     * @param null   $Heading
     */
    public function __construct(array &$TorrentList, array &$CollageDataList, string $EditType, $Heading = null)
    {
    ...
    private function no_torrents(): void
    {
        ?>
        <div class="thin">
            <div class="header">
                ...
                <tr>
                    <td id="drag_drop_textnote">
                        <ul>
                            ...
                            <li>Sort multiple columns simultaneously by holding down the shift key and clicking other
                                column headers.
                            </li>
    ...
    public function body(): void
    {
        if ($this->HasTorrents) {
            foreach ($this->TorrentList as $GroupID => $Group) {
                ...
                extract($this->CollageDataList[$GroupID], EXTR_OVERWRITE);
     ...
     */
    public static function display_name(array &$ExtendedArtists, array &$Artists, string $VanityHouse): string
    {
        $DisplayName = '';
     ...
     * @param string $EditType
     */
    public function set_edit_type($EditType): void
    {
