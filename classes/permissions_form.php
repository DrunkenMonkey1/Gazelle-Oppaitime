...
function permissions_form(): void
{
    ?>
                ...
                <tr>
                    <td>
                        ...
                        display_perm('site_delete_artist',
                            'Can delete artists (must be able to delete torrents+requests).');
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        display_perm('screenshots_add',
                            'Can add screenshots to any torrent and delete their own screenshots.');
