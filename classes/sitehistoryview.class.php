...
{
    public static function render_linkbox(): void
    {
    ...
    public static function render_events($Events): void
    {
    ...
    private static function render_tags($Tags): void
    {
        $Tags = explode(',', $Tags);
        natcasesort($Tags);
        $FormattedTags = '';
    ...
    public static function render_months($Months): void
    { ?>
        <div class="box">
    ...
    public static function render_search(): void
    { ?>
        <div class="box">
    ...
    public static function render_edit_form($Event): void
    { ?>
        <form id="event_form" method="post" action="">
            ...
            <table cellpadding="6" cellspacing="1" border="0" class="layout border" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" id="date" name="date" class="required"<?= $Event ? ' value="' . date('Y-m-d',
                ...
                <tr>
                    ...
                    <td>
                        <input type="text"
                               id="tags"
                               name="tags"
                               placeholder="Comma-separated tags; use periods/dots for spaces"
                               size="50"
                               value="<?= $Event['Tags'] ?>"/>
                        <select id="tag_list">
    ...
    public static function render_recent_sidebar($Events): void
    { ?>
        <div class="box">
            <div class="head colhead_dark">
