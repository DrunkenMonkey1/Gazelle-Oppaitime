...
<?php
    ...
    $Count = 0;
        ...
        ob_start();
        while ([$ID, $Enabled, $Class, $Donor, $Uploaded, $Downloaded, $Paranoia, $TreePosition, $TreeLevel] = G::$DB->next_record(MYSQLI_NUM, false)) {
    ...
    <strong><?=Users::format_username($ID, true, true, (2 != $Enabled ? false : true), true)?></strong>
<?php
