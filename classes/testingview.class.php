...
class TestingView
{
     ...
     * Render the linkbox
     */
    public static function render_linkbox($Page): void
    { ?>
        <div class="linkbox">
            <?php if ("classes" != $Page) { ?>
     ...
     */
    public static function render_classes($Classes): void
    { ?>
        <table>
            <tr class="colhead">
                <td>
            ...
            <?php foreach (array_keys($Classes) as $Key) {
     ...
     */
    public static function render_functions($Methods): void
    {
     ...
     */
    private static function render_method_definition($Method): string
    {
     ...
     */
    private static function render_method_params($Method): void
    { ?>
        <table>
     ...
     */
    public static function render_missing_documentation($Classes): void
    { ?>
        <table>
            <tr class="colhead">
                <td>
     ...
     */
    public static function render_results($Data): void
    {
