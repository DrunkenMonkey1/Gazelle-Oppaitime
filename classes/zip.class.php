...
class Zip
{
    ...
    public int $ArchiveFiles = 0;
    private string $Structure = '';
    private int $FileOffset = 0;
    private string $Data = ''; //An idea
    ...
    public static function unlimit(): void
    {
        ob_end_clean();
    ...
    public function add_file($FileData, $ArchivePath, $TimeStamp = 0): void
    {
        /* File header */
        ...
        $this->ArchiveSize += $FileDataLength; // All we really need is the size
    ...
    public function close_stream(): void
    {
