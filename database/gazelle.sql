...
CREATE DATABASE IF NOT EXISTS gazelle CHARACTER SET utf8mb4;
...
INSERT INTO tags (ID, Name, TagType, Uses, UserID)
VALUES (1, 'foo', 'genre', 0, 1),
       (2, 'bar', 'genre', 0, 1),
       (3, 'baz', 'genre', 0, 1);

INSERT INTO schedule (NextHour, NextDay, NextBiWeekly)
VALUES (0, 0, 0);

INSERT INTO forums_categories (ID, Sort, Name)
VALUES (1, 1, 'Site');

INSERT INTO forums_categories (ID, Sort, Name)
VALUES (5, 5, 'Community');
...
BEGIN
    IF ((OLD.timespent < NEW.timespent) AND (OLD.active = 1) AND (NEW.active = 1)) THEN
        ...
        VALUES (NEW.uid, NEW.fid, NEW.timespent, NEW.uploaded, NEW.downloaded, NOW())
        ON DUPLICATE KEY UPDATE SeedTime   = SeedTime + (NEW.timespent - OLD.timespent),
